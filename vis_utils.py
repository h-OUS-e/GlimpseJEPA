...
def plot_glimpse_frames(glimpse_frames, max_batch: int = 3, title: str = ""):
    """
    ...
    Args:
        title: optional label prepended to the default rows/cols caption.
    """
    ...
    for b in range(min(max_batch, B)):
        for t in range(T_max):
            ...
            ax.axis('off')
    caption = "rows = batch, cols = t (after applying delta t)"
